...
public class UsersService extends at.fhtw.users.service.UserAbstractService {
    ...
    public Response getUsers() {
        ...
        Users users = new Users(1,"admin", "admin", "anpch@example.com", "admin", "admin");
        String Json = null;
        try{
    ...
    public Response addUser(Request request) {
        try {
            ...
            return new Response(HttpStatus.CREATED, ContentType.JSON, "Benutzer erfolgreich hinzugefügt");
